...
@block
def sig_assigner_wrapper(clock, signal_in, signal_out):
...
class TestSigAssignerInterface(KeaTestCase):
    ...
    def test_intbv_ports_checked(self):
        ...
        signal_out_required_val_range = (
            self.dut_args['signal_in'].min,
            self.dut_args['signal_in'].max)
...
class TestSigAssigner(KeaTestCase):
    ...
    def base_test(
        ...
        dut_outputs, ref_outputs = self.cosimulate(
            cycles, sig_assigner_wrapper, sig_assigner_wrapper,
            dut_wrapper_args, dut_wrapper_arg_types,
    ...
    def test_signal_assignment(self):
        '''The `sig_assigner` should asynchronously assign `signal_in` to
        `signal_out`.
        '''
        self.base_test()

    def test_bool_to_bool(self):
        '''The `sig_assigner` should function correctly when `signal_in`
...
class TestSigAssignerVivadoVhdl(
    KeaVivadoVHDLTestCase, TestSigAssigner):
    pass

class TestSigAssignerVivadoVerilog(
    KeaVivadoVerilogTestCase, TestSigAssigner):
    pass
