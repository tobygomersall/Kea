...
class TestSyncSigAssignerWithResetInterface(KeaTestCase):
    ''' The sync_sig_assigner_with_reset should reject incompatible interfaces
    and arguments.
    '''
    ...
    def test_bool_ports_checked(self):
        ...
        '''
        dut = sync_sig_assigner_with_reset
...
class TestSyncSigAssignerWithReset(KeaTestCase):
    ...
    def base_test(
        ...
        dut_outputs, ref_outputs = self.cosimulate(
            cycles, sync_sig_assigner_with_reset,
            sync_sig_assigner_with_reset, dut_args,
            dut_arg_types, custom_sources=[(stimulate_check, (), dut_args)])

        self.assertEqual(dut_outputs, ref_outputs)

    def test_signal_assignment(self):
        '''The `sync_sig_assigner_with_reset` should synchronously assign
        `signal_in` to `signal_out`.

        If `reset` is high then `signal_out` should be set to 0.
        '''
        self.base_test()

    def test_bool_to_bool(self):
        '''The `sync_sig_assigner_with_reset` should function correctly when
        `signal_in` is a bool and signal out is a bool.
        '''
        self.base_test(input_bitwidth='bool', output_bitwidth='bool')

    def test_bool_to_one_bit_intbv(self):
        '''The `sync_sig_assigner_with_reset` should function correctly when
        `signal_in` is a bool and signal out is a one bit `intbv`.
        '''
        self.base_test(input_bitwidth='bool', output_bitwidth=1)

    def test_one_bit_intbv_to_bool(self):
        '''The `sync_sig_assigner_with_reset` should function correctly when
        `signal_in` is a one bit `intbv` and signal out is a bool.
        '''
        self.base_test(input_bitwidth=1, output_bitwidth='bool')

    def test_bool_to_wider_intbv(self):
        '''The `sync_sig_assigner_with_reset` should function correctly when
        `signal_in` is a bool and signal out is an n bit wide `intbv`.
        '''
    ...
    def test_unsigned_intbv_to_signed_intbv(self):
        '''The `sync_sig_assigner_with_reset` should function correctly when
        `signal_in` is an unsigned `intbv` and signal out is a signed `intbv`.
        Note the positive range of `signal_out` needs to be able to accomodate
        the full range of `signal_in`.
        '''
        input_bitwidth = random.randrange(2, 9)
...
class TestSyncSigAssignerWithResetVivadoVhdl(
    KeaVivadoVHDLTestCase, TestSyncSigAssignerWithReset):
    pass

class TestSyncSigAssignerWithResetVivadoVerilog(
    KeaVivadoVerilogTestCase, TestSyncSigAssignerWithReset):
    pass
